...
const print_user_by_id = (req, res, next) => {
  print_user_by_id_data(req, res, function (status, _activity) {
    next(status, _activity);
  });
};


function print_user_by_id_data(req, res, next) {
...
module.exports = print_user_by_id;
